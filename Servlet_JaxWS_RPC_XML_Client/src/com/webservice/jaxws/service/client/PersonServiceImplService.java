 ...
 * 
 */
@WebServiceClient(name = "PersonServiceImplService", targetNamespace = "http://service.jaxws.webservice.com/", wsdlLocation = "http://localhost:8083/Servlet_JaxWS_RPC_XML/personWS?wsdl")
public class PersonServiceImplService extends Service {
	...
	private final static QName PERSONSERVICEIMPLSERVICE_QNAME = new QName("http://service.jaxws.webservice.com/",
	...
	static {
		...
		try {
			url = new URL("http://localhost:8083/Servlet_JaxWS_RPC_XML/personWS?wsdl");
	...
	public PersonService getPersonServiceImplPort() {
		return super.getPort(new QName("http://service.jaxws.webservice.com/", "PersonServiceImplPort"),
				PersonService.class);
	}
