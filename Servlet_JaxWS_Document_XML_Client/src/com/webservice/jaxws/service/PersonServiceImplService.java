 ...
 * 
 */
@WebServiceClient(name = "PersonServiceImplService", targetNamespace = "http://service.jaxws.webservice.com/", wsdlLocation = "http://localhost:8083/Servlet_Jaxws_Document_XML/personWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8083/Servlet_Jaxws_Document_XML/personWS?wsdl");
